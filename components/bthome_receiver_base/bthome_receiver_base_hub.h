...
namespace esphome
{
  namespace bthome_receiver_base
  {
    ...
    protected:
      ...
      virtual void report_measurement_(bthome_measurement_record_t measurement, mac_address_t address, BTHomeReceiverBaseDevice *btdevice, bool &device_header_reported);
