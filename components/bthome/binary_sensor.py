...
MEASUREMENT_TYPES_BINARY_SENSOR = {
  ...
  "battery_charging": {"measurement_type": 0x16, "device_class": DEVICE_CLASS_BATTERY_CHARGING},
  ...
  "connectivity": {"measurement_type": 0x19, "device_class": DEVICE_CLASS_CONNECTIVITY},
...
CONFIG_SCHEMA, to_code = bthome_shared_sensor_configs(True, MEASUREMENT_TYPES_BINARY_SENSOR)
